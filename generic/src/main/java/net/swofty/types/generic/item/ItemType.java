...
public enum ItemType {
    ...
    SPEED_RING(Material.PLAYER_HEAD, Rarity.UNCOMMON, SpeedRing.class),
    SPEED_ARTIFACT(Material.PLAYER_HEAD, Rarity.RARE, SpeedArtifact.class),
    ...
    BAT_RING(Material.PLAYER_HEAD, Rarity.EPIC, BatRing.class),
    BAT_ARTIFACT(Material.PLAYER_HEAD, Rarity.LEGENDARY, BatArtifact.class),
    DEVOUR_RING(Material.PLAYER_HEAD, Rarity.RARE, DevourRing.class),
